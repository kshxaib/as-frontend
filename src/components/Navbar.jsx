    ...
    <>
      <header className="sticky top-0 z-40 w-full border-b border-slate-800/80 bg-slate-950/80 backdrop-blur-xl">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          {/* ── Desktop Nav ── */}
          <nav className="hidden md:flex items-center gap-1 rounded-2xl border border-slate-800 bg-slate-900/60 p-1 backdrop-blur-md">
            {visibleTabs.map((item) => {
              ...
              return (
                <button
                  ...
                  className={`relative flex items-center gap-2 rounded-xl px-3.5 py-1.5 text-xs font-semibold transition-all duration-150 ${
                    isActive
