...
export const Navbar = () => {
  ...
  const navItems = [
    ...
    { id: 'review', label: 'Question Review', icon: Layers },
    { id: 'solutions', label: 'Solved Answers', icon: FileCheck2, badge: currentAnswerSet?.completed_questions },
    { id: 'community', label: 'Community Hub', icon: Globe },
    { id: 'profile', label: 'Profile & API Keys', icon: User },
  ];
          ...
          {isAuthenticated && user ? (
            <div className="flex items-center gap-3">
              ...
              >
                ...
                <span>{user.has_openai_key ? 'OpenAI Key Active' : 'No Key (View Only)'}</span>
              </div>
            ...
            <button
              ...
              className="flex items-center gap-2 rounded-xl bg-gradient-to-r from-indigo-600 to-indigo-500 px-4 py-2 text-xs font-semibold text-white shadow-lg shadow-indigo-500/25 hover:from-indigo-500 hover:to-indigo-400 transition-all"
            >
