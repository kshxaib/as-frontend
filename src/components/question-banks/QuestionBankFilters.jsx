...
/**
 * QuestionBankFilters — search + subject filter + sort.
...
export function QuestionBankFilters({
  ...
  return (
    <div
      data-slot="question-bank-filters"
    ...
    >
      ...
      <div className="relative max-w-md flex-1 lg:min-w-72">
        ...
        <Input
          ...
          aria-label="Search question banks by title or subject"
